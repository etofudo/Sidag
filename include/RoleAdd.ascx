<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RoleAdd.ascx.cs" Inherits="include_RoleAdd" %>
...
<table style="width:100%;background-color:#ffffff" class="auto-styleT5">
    <tr>
        <td class="auto-styleT7">REGISTER&nbsp; ROLE&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="auto-style1">Role:<asp:TextBox ID="txtt" runat="server" Width="100%" Height="40px" CssClass="auto-styleTT1"></asp:TextBox>
        </td>
    </tr>

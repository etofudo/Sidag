<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DepartmentAdd.ascx.cs" Inherits="include_DepartmentAdd" %>
...
<table style="width:100%;background-color:#ffffff" class="auto-styleT5">
    <tr>
        <td class="auto-styleT7">REGISTER&nbsp; DEPARTMENT&nbsp;</td>
    </tr>
    <tr>
     ...
     <tr>
        <td class="auto-style1">Department Name:<asp:TextBox ID="txted" runat="server" Width="100%" Height="40px" CssClass="auto-styleTT1"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="auto-style1">

...
<table style="width:100%;background-color:#ffffff" class="auto-styleT5">
    ...
    <tr>
        <td class="auto-style1">Title:<asp:TextBox ID="TextBox2" runat="server" Width="426px" CssClass="auto-styleTT1" TextMode="Date"></asp:TextBox>
        </td>
    </tr>
     <tr>
        <td class="auto-style1">Author:<asp:TextBox ID="TextBox1" runat="server" Width="426px" CssClass="auto-styleTT1" TextMode="Date"></asp:TextBox>
        </td>
    </tr>
    <tr>

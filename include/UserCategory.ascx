<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserCategory.ascx.cs" Inherits="include_UserCategory" %>
...
<table style="width:100%;background-color:#ffffff" class="auto-styleT5">
    <tr>
        <td class="auto-styleT7">REGISTER&nbsp; USER&nbsp; CATEGORY&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="auto-style1">Category:<asp:TextBox ID="txtt" runat="server" Width="100%" Height="40px" CssClass="auto-styleTT1"></asp:TextBox>
        </td>
    </tr>
